...
# [10.0] Extended user access rights at Odoo

<br/>:heavy_check_mark: [access_apps](https://apps.odoo.com/apps/modules/10.0/access_apps/)
...
<br/>:heavy_check_mark: [access_limit_records_number](https://apps.odoo.com/apps/modules/10.0/access_limit_records_number/)
<br/>:heavy_check_mark: [access_menu_extra_groups](https://apps.odoo.com/apps/modules/10.0/access_menu_extra_groups/)
<br/>:heavy_check_mark: [access_restricted](https://apps.odoo.com/apps/modules/10.0/access_restricted/)
<br/>:heavy_check_mark: [access_settings_menu](https://apps.odoo.com/apps/modules/10.0/access_settings_menu/)
<br/>:heavy_check_mark: [apps](https://apps.odoo.com/apps/modules/10.0/apps/)
<br/>:heavy_check_mark: [group_menu_no_access](https://apps.odoo.com/apps/modules/10.0/group_menu_no_access/)
<br/>:heavy_check_mark: [hidden_admin](https://apps.odoo.com/apps/modules/10.0/hidden_admin/)
